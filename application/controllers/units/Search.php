...
class Search extends CI_Controller {
	...
	public function index()
	{
        	...
        	$this->load->model('units/Search_model', '', TRUE);
			...
			$this->load->view('units/search_content',$data);
			$this->load->view('footer_table');
			$this->load->view('units/search_footer_script');
	}
	public function profile()
	{
			...
			$this->load->view('header_table',$data);
			$this->load->view('units/sidebar');
			$this->load->view('units/search_profile_content',$data);
			$this->load->view('footer');
	}
	public function ajax_list()
	{
		$this->load->model('units/Search_model');
